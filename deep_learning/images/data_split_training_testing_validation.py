...
DATASET_FILE = expanduser("~")
DATASET_FILE += "/hackweek/image_csku_list.csv"


FILE_TRAIN = expanduser("~")
FILE_TRAIN += "/hackweek/train.csv"

FILE_VALID = expanduser("~")
FILE_VALID += "/hackweek/validation.csv"


FILE_TESTS = expanduser("~")
FILE_TESTS += "/hackweek/test.csv"
